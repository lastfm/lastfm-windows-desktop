...
namespace Transitions
{
    ...
    public class Transition
	{
	    ...
	    public event EventHandler<Args> TransitionCancelledEvent;
	    ...
	    public void Stop()
	    {
			// Stops the animation dead in its tracks
			m_Stopwatch.Stop();

			// We raise an event to notify any observers that the transition has been cancelled...
			Utility.raiseEvent(TransitionCancelledEvent, this, new Args());
	    }
